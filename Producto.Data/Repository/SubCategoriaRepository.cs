...
{
    public class SubCategoriaRepository : BaseRepository<ProductoContext>, ISubCategoriaRepository
    {
        public SubCategoriaRepository(ProductoContext commonContext) : base(commonContext)
        {
        }
