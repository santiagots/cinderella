...
Public Class frmSincronizacion
    ...
    Private Async Sub SincronizarDatos()
        ...
        Dim tablasRemotas() As String = {"REL_REGISTRO_EMPLEADOS", "REL_REGISTRO_EMPLEADOS_AUSENTES", "REL_USUARIOS_PERFILES", "STOCK", "ADELANTOS", "STOCK_BITACORA", "ADICIONALES", "SUCURSALES", "AROMAS", "SUELDOS", "BANCOS", "TIPOS_COMISIONES", "TIPOS_EGRESOS", "CHEQUE", "TIPOS_PAGO", "CLIENTEMAYORISTA", "TIPOS_VENTAS", "COLORES", "USUARIOS", "COMISIONES", "USUARIOS_MENSAJES", "CONDICIONES_IVA", "VENTAS", "VENTAS_DETALLE", "CONSUMIDORFINAL", "PRESUPUESTO", "PRESUPUESTO_DETALLE", "CUENTA_CORRIENTE", "DEPARTAMENTOS", "DEUDA", "DEVOLUCIONES", "DEVOLUCIONES_DETALLE", "EMPLEADOS", "EMPLEADOS_DEPOSITOS", "EMPLEADOS_RECIBOS", "EMPLEADOS_REGISTROS", "EMPLEADOS_TIPOS", "FACTURACION", "FERIADOS", "LISTA_GRUPO", "LISTA_PRECIO", "LOCALIDADES", "MATERIALES", "MERCADERIAS", "MERCADERIAS_DETALLE", "MOVIMIENTOS", "MOVIMIENTOS_APORTE", "MOVIMIENTOS_CAJA_FUERTE", "MOVIMIENTOS_EGRESOS", "MOVIMIENTOS_GASTOS", "MOVIMIENTOS_IMPUESTOS", "MOVIMIENTOS_MERCADERIAS", "MOVIMIENTOS_RETIROS", "MOVIMIENTOS_SECCIONES", "MOVIMIENTOS_SUBTIPOS", "MOVIMIENTOS_TIPOEGRESO_TIPOGASTO", "MOVIMIENTOS_TIPOS", "NOTACREDITO", "PATENTES", "PATENTES_GRUPO", "PERFILES", "PRECIOS", "PRECIOS_VIEJO", "PRODUCTOS", "PRODUCTOS_CATEGORIAS", "PRODUCTOS_CATEGORIAS_VIEJO", "PRODUCTOS_SUBCATEGORIAS", "PRODUCTOS_SUBCATEGORIAS_VIEJO", "PRODUCTOS_VIEJO", "PROVEEDORES", "PROVEEDORES_VIEJO", "PROVINCIAS", "REL_EMPLEADOS_SUCURSALES", "REL_PERFILES_PATENTES", "REL_PRODUCTOS_AROMAS", "REL_PRODUCTOS_COLORES", "REL_PRODUCTOS_MATERIALES", "SINCORNIZACION", "SENIA", "CLIENTEMINORISTA", "TARJETAS", "COSTOFINANCIERO"}
