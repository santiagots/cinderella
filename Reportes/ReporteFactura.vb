...
Public Class ReporteFactura
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SistemaCinderella.ReporteFactura.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_rutaImagen() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedReporteFactura
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ReporteFactura = New ReporteFactura()
        rpt.Site = Me.Site
        Return rpt
    End Function
