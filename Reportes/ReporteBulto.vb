...
Public Class ReporteBulto
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SistemaCinderella.ReporteBulto.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedReporteBulto
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ReporteBulto = New ReporteBulto()
        rpt.Site = Me.Site
        Return rpt
    End Function
