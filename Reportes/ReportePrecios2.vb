...
Public Class ReportePrecios2
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SistemaCinderella.ReportePrecios2.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedReportePrecios2
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ReportePrecios2 = New ReportePrecios2()
        rpt.Site = Me.Site
        Return rpt
    End Function
