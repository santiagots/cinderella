Public Class frmVerRegulares
    ...
    Private Sub frmVerRegulares_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try
            ...
            Registros = NegRegistros.ListarDiasRegularesEmpleado(id_Empleado, id_Sucursal, FDesde, FHasta)
            ...
            Me.Text = "Días trabajados Regulares " & eEmpleado.Apellido.ToUpper & " " & eEmpleado.Nombre.ToUpper
        ...
        Catch ex As Exception
            Me.Cursor = Cursors.Arrow
            MessageBox.Show(ex.Message.ToString, "Dias Regulares", MessageBoxButtons.OK, MessageBoxIcon.Error)
        End Try
    End Sub
