...
namespace Ventas.Core.Interfaces
{
    public interface IVentaRepository
    {
        ...
        decimal ObtenerTotal(int idSucursal, DateTime fechaDesde, DateTime fechaHasta, bool? facturado, TipoPago? tipoPago, TipoCliente? tipoCliente);
        decimal ObtenerTotal(int idSucursal, DateTime fecha, bool? facturado, TipoPago? tipoPago, TipoCliente? tipoCliente);
    }
}
