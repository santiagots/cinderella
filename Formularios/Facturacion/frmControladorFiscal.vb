...
Public Class frmControladorFiscal
    ...
    Private Sub btnCierreZPorFecha_Click(sender As Object, e As EventArgs) Handles btnCierreZPorFecha.Click
        Ejecutar(Sub() frmControladorFiscalViewModel.CierreZPorFecha())
    End Sub
