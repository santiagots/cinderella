...
Public Class frmVentasAdministracion
    ...
    Private Sub frmVentasAdministracion_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        EjecutarAsync(Async Function() As Task
                          ...
                          EvaluarPermisos()
                          ventasAdministracionViewModel = New frmVentasAdministracionViewModel(My.Settings.Sucursal)
    ...
    Private Sub btnReporteVenta_Click(sender As Object, e As EventArgs) Handles btnReporteVenta.Click
        EjecutarAsync(Async Function() As Task
                          Await ventasAdministracionViewModel.ImprimirAsync(Me.MdiParent)
                      End Function)
    End Sub
    ...
    Private Sub BtnAnular_Click(sender As Object, e As EventArgs) Handles BtnAnular.Click
        EjecutarAsync(Async Function() As Task
                          ...
                          MessageBox.Show("La venta se han anulado de forma correcta.", "Administración de Ventas", MessageBoxButtons.OK, MessageBoxIcon.Information)
                      End Function)
    End Sub

    Private Sub BtnFacturaDetalle_Click(sender As Object, e As EventArgs) Handles BtnFacturaDetalle.Click
        Ejecutar(Sub()
                     ventasAdministracionViewModel.MostrarFacturaDetalle()
                 End Sub)
    End Sub

    Private Sub BtnEmitirFactura_Click(sender As Object, e As EventArgs) Handles BtnEmitirFactura.Click
        Ejecutar(Sub()
                     ventasAdministracionViewModel.Faturar(Me.MdiParent)
                     MessageBox.Show("La venta se han facturado de forma correcta.", "Administración de Ventas", MessageBoxButtons.OK, MessageBoxIcon.Information)
                 End Sub)
    End Sub
    ...
    'Dim NegFacturacion As New NegFacturacion
    ...
    '    For Each factura As Facturacion In frmFacturar.Facturas
    '        factura.id_Venta = id_VentaDetalle
