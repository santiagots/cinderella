...
Public Class frmReporteResumenReserva
    ...
    Public idReserva As Int64
    Public MontoSenia As Decimal
    ...
    Private Sub frmReporteResumenVenta_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        Dim dsVentas As DataSet = negVenta.TraerVenta(idReserva)
        ...
        Dim dsventaDetalles As DataSet = negVenta.TraerVentaDetalle(idReserva)
        ...
        Dim rpt
        If tiposVenta = "Minorista" Then
            rpt = New ReporteReservaMinorista
        Else
            rpt = New ReporteReservaMayorista
        ...
        CType(rpt.ReportDefinition.ReportObjects("TxtSenia"), TextObject).Text = MontoSenia.ToString("C2")
        CType(rpt.ReportDefinition.ReportObjects("TxtTotal"), TextObject).Text = (precioTotal - MontoSenia).ToString("C2")
