...
Partial Class frmMovimientoCaja
    ...
    Private Sub InitializeComponent()
        ...
        Me.ToolCaja.SetToolTip(Me.btnCancelar, "Al cancelar el formulario se restablecerán todas las opciones del formulario.")
        ...
        Me.ToolCaja.SetToolTip(Me.btnAceptar, "Al aceptar el formulario se registrará en el sistema la diferencia de caja.")
        ...
        Me.GroupBox1.Text = "Alta de movimientos de ""Diferencia de Caja"" en la sucursal."
        '
        'Label5
        '
        ...
        Me.Text = "Movimientos | Diferencia de Caja"
