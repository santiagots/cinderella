Public Class frmVerDevoluciones
    ...
    Private Sub frmVerVentas_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try
            ...
            dsVentas = NegDevolucion.ObtenerDevolucionesSucursalListado(id_Sucursal, FDesde, FHasta)
            ...
            'Empleado
            Me.Text = "Devoluciones de la sucursal " & My.Settings("NombreSucursal")
            Gb_Comisiones.Text = "Devoluciones registradas entre el " & FDesde & " hasta el " & FHasta

            'Cambio el cursor a "NORMAL"
            Me.Cursor = Cursors.Arrow
        Catch ex As Exception
            Me.Cursor = Cursors.Arrow
            MessageBox.Show(ex.Message.ToString, "Devoluciones", MessageBoxButtons.OK, MessageBoxIcon.Error)
        End Try
    End Sub
