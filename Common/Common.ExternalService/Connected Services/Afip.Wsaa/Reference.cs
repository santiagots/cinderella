...
namespace Common.ExternalService.Afip.Wsaa {
    ...
    public interface LoginCMS {
        ...
        [System.ServiceModel.FaultContractAttribute(typeof(Common.ExternalService.Afip.Wsaa.LoginFault), Action="", Name="fault")]
        Common.ExternalService.Afip.Wsaa.loginCmsResponse loginCms(Common.ExternalService.Afip.Wsaa.loginCmsRequest request);
        
        [System.ServiceModel.OperationContractAttribute(Action="", ReplyAction="*")]
        System.Threading.Tasks.Task<Common.ExternalService.Afip.Wsaa.loginCmsResponse> loginCmsAsync(Common.ExternalService.Afip.Wsaa.loginCmsRequest request);
    }
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface LoginCMSChannel : Common.ExternalService.Afip.Wsaa.LoginCMS, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class LoginCMSClient : System.ServiceModel.ClientBase<Common.ExternalService.Afip.Wsaa.LoginCMS>, Common.ExternalService.Afip.Wsaa.LoginCMS {
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        Common.ExternalService.Afip.Wsaa.loginCmsResponse Common.ExternalService.Afip.Wsaa.LoginCMS.loginCms(Common.ExternalService.Afip.Wsaa.loginCmsRequest request) {
            return base.Channel.loginCms(request);
        }
        
        public string loginCms(string in0) {
            Common.ExternalService.Afip.Wsaa.loginCmsRequest inValue = new Common.ExternalService.Afip.Wsaa.loginCmsRequest();
            inValue.in0 = in0;
            Common.ExternalService.Afip.Wsaa.loginCmsResponse retVal = ((Common.ExternalService.Afip.Wsaa.LoginCMS)(this)).loginCms(inValue);
            return retVal.loginCmsReturn;
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        System.Threading.Tasks.Task<Common.ExternalService.Afip.Wsaa.loginCmsResponse> Common.ExternalService.Afip.Wsaa.LoginCMS.loginCmsAsync(Common.ExternalService.Afip.Wsaa.loginCmsRequest request) {
            return base.Channel.loginCmsAsync(request);
        }
        
        public System.Threading.Tasks.Task<Common.ExternalService.Afip.Wsaa.loginCmsResponse> loginCmsAsync(string in0) {
            Common.ExternalService.Afip.Wsaa.loginCmsRequest inValue = new Common.ExternalService.Afip.Wsaa.loginCmsRequest();
            inValue.in0 = in0;
            return ((Common.ExternalService.Afip.Wsaa.LoginCMS)(this)).loginCmsAsync(inValue);
        }
    }
}
